...
许多 Appium 1.5 中的服务器参数已被弃用，取而代之使用的是 [-default-capabilities 标识](https://github.com/appium/appium/blob/master/docs/en/writing-running-appium/default-capabilities-arg.md) 。
